...
% Define colors
\definecolor{sectioncolor}{rgb}{0.33,0.51,0.21}
\definecolor{headingcolor}{rgb}{0.33,0.51,0.21} % Added definition for headingcolor
% Define the resumeItem command
...
% BEGIN_skills
% ADDITIONAL SKILLS SECTION START
